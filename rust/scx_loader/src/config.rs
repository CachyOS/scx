    ...
    Config {
        ...
        scheds: HashMap::from([
            (
                ...
                Sched {
                    auto_mode: vec![].into(),
                    gaming_mode: vec!["-k".into(), "-m".into(), "performance".into()].into(),
                    lowlatency_mode: vec!["--lowlatency".into()].into(),
                    powersave_mode: vec!["-m".into(), "powersave".into()].into(),
                },
            ),
            (
                "scx_rusty".to_string(),
                Sched {
                    auto_mode: vec![].into(),
                    gaming_mode: vec![].into(),
                    lowlatency_mode: vec![].into(),
                    powersave_mode: vec![].into(),
                },
            ),
            (
                "scx_lavd".to_string(),
                Sched {
                    auto_mode: vec![].into(),
                    gaming_mode: vec!["--performance".into()].into(),
                    lowlatency_mode: vec!["--performance".into()].into(),
                    powersave_mode: vec!["--powersave".into()].into(),
                },
            ),
        ]),
    }
